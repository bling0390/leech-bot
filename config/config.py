...
MAXIMUM_NOTIFY_WORKER = int(environ.get('MAXIMUM_NOTIFY_WORKER', config.get('MAXIMUM_NOTIFY_WORKER', '1')))
DISK_FREE_THRESHOLD_BYTES = int(
    environ.get('DISK_FREE_THRESHOLD_BYTES', config.get('DISK_FREE_THRESHOLD_BYTES', '0'))
)
...
LEECH_RETRY_BATCH_SIZE = int(environ.get(
    'LEECH_RETRY_BATCH_SIZE',
    config.get('LEECH_RETRY_BATCH_SIZE', '200')
))
LEECH_RATE_CONTROL_TIMEOUT = float(environ.get(
    'LEECH_RATE_CONTROL_TIMEOUT',
    config.get('LEECH_RATE_CONTROL_TIMEOUT', '5')
))
LEECH_TERMINATE_CONTROL_TIMEOUT = float(environ.get(
    'LEECH_TERMINATE_CONTROL_TIMEOUT',
    config.get('LEECH_TERMINATE_CONTROL_TIMEOUT', '5')
))
LEECH_TERMINATE_SIGNAL = environ.get(
    'LEECH_TERMINATE_SIGNAL',
    config.get('LEECH_TERMINATE_SIGNAL', 'SIGTERM')
)
